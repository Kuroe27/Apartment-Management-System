...
INSERT INTO Apartment (apartment_name, apartment_description)
VALUES ('Apartment 1', 'A cozy one-bedroom apartment');
-- Insert data into the Rooms table, associating with Apartment 1
INSERT INTO Rooms (apartment_id, rent)
VALUES (1, 1000.00);
...
-- INSERT INTO Invoices (tenant_id, date_created, due_date, total_amount, status)
-- VALUES (1, '2023-10-22', '2023-11-22', 1000.00, 'Unpaid');
